...
$odds=\frac{P\left(\text{combi}C_1 \mid X\right)}{P\left(\combi{C}_2\mid X\right)}=\combi{e}^z$odds=P(C1​∣X)P(C2​∣X)​=ez​

클래스가 k개 일때로 일반화 하면

$\frac{P\left(\combi{C}_i\mid X\right)}{P\left(\combi{C}_k\mid X\right)}=\combi{e}^{\combi{z}_i}$P(Ci​∣X)P(Ck​∣X)​=ezi​​

양변을 i=1부터 k-1까지 더하면

$\sum _{i=1}^{k-1}\frac{P\left(\combi{C}_i\mid X\right)}{P\left(\combi{C}_k\mid X\right)}=\sum _{i=1}^{k-1}\combi{e}^{\combi{z}_i}$k−1∑i=1P(Ci​∣X)P(Ck​∣X)​=k−1∑i=1ezi​​

$\frac{P\left(\combi{C}_1\mid X\right)+P\left(\combi{C}_2\mid X\right)+\cdot \cdot \cdot +P\left(\combi{C}_{k-1}\mid X\right)}{P\left(\combi{C}_k\mid X\right)}=\sum _{i=1}^{k-1}\combi{e}^{\combi{z}_i}$P(C1​∣X)+P(C2​∣X)+···+P(Ck−1​∣X)P(Ck​∣X)​=k−1∑i=1ezi​​

$\frac{1-P\left(\combi{C}_k\mid X\right)}{P\left(\combi{C}_k\mid X\right)}=\sum _{i=1}^{k-1}\combi{e}^{\combi{z}_i}$1−P(Ck​∣X)P(Ck​∣X)​=k−1∑i=1ezi​​

$P\left(\combi{C}_k\mid X\right)=\frac{1}{1+\sum _{i=1}^{k-1}\combi{e}^{\combi{z}_i}}$P(Ck​∣X)=11+k−1∑i=1ezi​​​

odds를 일반화 한 식에서 P(Ci|X)에 대해 정리하면

$P\left(\combi{C}_i\mid X\right)=\combi{e}^{\combi{z}_i}P\left(\combi{C}_k\mid X\right)$P(Ci​∣X)=ezi​P(Ck​∣X)​

$P\left(\combi{C}_i\mid X\right)=\frac{\combi{e}^{\combi{z}_i}}{1+\sum _{i=1}^{k-1}\combi{e}^{\combi{z}_i}}$P(Ci​∣X)=ezi​1+k−1∑i=1ezi​​​

i 대신 k를 넣으면 1이므로

$\frac{P\left(\combi{C}_k\mid X\right)}{P\left(\combi{C}_k\mid X\right)}=\combi{e}^{\combi{z}_k}=1$P(Ck​∣X)P(Ck​∣X)​=ezk​=1​

이를 이용하면 softmax가 된다.

$P\left(\combi{C}_i\mid X\right)=\frac{\combi{e}^{\combi{z}_i}}{\sum _{i=1}^k\combi{e}^{\combi{z}_i}}$P(Ci​∣X)=ezi​k∑i=1ezi​​​
