...
![[team-blog-코딩황제들-2024-week1.세준1.png]]
...
$-\log \left({p}_i\right){,\ p}_i\ =사건의\ 확률$​

cross entropy는 두 가지 확률 분포간의 차이를 나타낼 수 있다.

$H\left(P,\ Q\right)=-\sum _i^n{p}_i\log \left({q}_i\right)$
...
$L=-\frac{1}{N}\sum _{j=1}^N\sum _{i=1}^Cp_{ij}\log \left({q}_{ij}\right)$
